...
# Virtual environment ini digunakan untuk Backend dan AI Worker

Write-Host "=== Setup Virtual Environment untuk Project CCTV AI ===" -ForegroundColor Green
...
Write-Host "`nUntuk menjalankan Backend (FastAPI):" -ForegroundColor Cyan
Write-Host "  cd backend" -ForegroundColor White
Write-Host "  uvicorn app.main:app --reload" -ForegroundColor White
Write-Host "`nUntuk menjalankan AI Worker:" -ForegroundColor Cyan
Write-Host "  cd ai-worker" -ForegroundColor White
Write-Host "  python ai_worker.py" -ForegroundColor White
